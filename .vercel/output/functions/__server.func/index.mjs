...
import { H3Core, HTTPError, createMatcherFromFind, defineLazyEventHandler, headers, memoizeRouteRulesMatcher } from "./_libs/h3+rou3+srvx.mjs";
...
var _lazy_ygC73M = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_ygC73M
	};
	return ((_m, p) => {
		return {
			data,
