...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-iAgnBJop.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DFrhMlxI.mjs"),
		import("./start-CAarXtBI.mjs"),
...
//#endregion
export { createCsrfMiddleware, createMiddleware, server_exports };
